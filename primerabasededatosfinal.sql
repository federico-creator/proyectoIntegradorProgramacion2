...
insert into usuarios values (default,"Eze","Martin",13229842,"1980.12.30","escuela3123","mimail@yahoo.com.ar","2020.14.11","2020.14.11");
...
insert into usuarios values (default,"Chino","Martinez",22294562,"1989.11.13","chinito123","CM@oulook.com","2018.04.19");
...
select * from productos order by updated_at desc;usuarios

insert into comentarios values (default,"2020.10.05","2020.10.05","excelente",1,1);
insert into comentarios values (default,"2020.14.11","2020.14.11","muy bueno",2,1);
...
insert into comentarios values (default,"2020.17.25","2020.17.25","muy bueno",2,2);
